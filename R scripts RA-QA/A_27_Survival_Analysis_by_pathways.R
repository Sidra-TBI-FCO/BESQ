...
Outcome = "OS" # "DSS" "OS"
Ethnicity_variable = "Ethnicity" #"Ethnicity_reported_simple"
cbPalette = c("lightblue", "orange")
ICR_cluster = "All" # "All", "ICR High", "ICR Medium", "ICR Low"
#IMS_group = "IMS_Mathews" # "IMS", "IMS_Mathews"
#IMS = "BasalMyo"
Pathway = "[IPA] AMPK Signaling" #"[TBI] Barrier genes" #"[IPA] ERK MAPK Signaling" #"[HM] TGF beta signaling" #"[IPA] ErbB2 ErbB3 Signaling" #"[HM] Glycolysis" #"[IPA] AMPK Signaling"
...
#load("./Analysis/Benefit_Cluster/significant_pathways_and_importance_in_gxboost_BasalMyo.Rdata")
load(paste0("./Analysis/A_26_Selected_pathway_classification/[IPA] AMPK Signaling_Arab_binary_classification.Rdata"))
...
dir.create("./Figures/Kaplan_meiers/A27_survival_by_pathway_category", showWarnings = FALSE)
...
Survival_data_1 = Survival_data_1[which(Survival_data_1[, Ethnicity_variable] %in% Ethnicity),]
...
Survival_data$cluster = df$Category[match(Survival_data$Sample_ID, df$Sample)]
...
if(classification == "tertiles"){
  TS.Surv[,"Group"] = factor(TS.Surv[,"Group"], levels = c("Pathway High", "Pathway Medium", "Pathway Low"))
}
...
# plots
png(paste0("./Figures/Kaplan_meiers/A27_survival_by_pathway_category/July_2019_", Ethnicity_variable,"_", Ethnicity, "_", Pathway,"_", classification, "_", ICR_cluster, "_", Outcome, "_Kaplan_Meijer_by_cluster.png"),

...
for (i in 1:N.sets) {
  ...
  TS.Surv[,"Group"] = factor(TS.Surv[,"Group"], levels = c("Arab", "Asian"))
  
  # Check this!!
  ##TS.Surv[,"Group"] = relevel(TS.Surv[,"Group"], "ICR High")
  mHR = coxph(formula = msurv ~ TS.Surv[,"Group"],data = TS.Surv, subset = TS.Surv$Group %in% c("Arab", "Asian"))
  ...
  # plots
  png(paste0("./Figures/Kaplan_meiers/A7_survival_by_IMS/", IMS, "_", Outcome, "_Kaplan_Meijer_by_ethnicity_with_at_risk_table.png"),

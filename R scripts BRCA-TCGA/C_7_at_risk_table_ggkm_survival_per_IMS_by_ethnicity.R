...
IMS_categories = c("All", names(table(Clinical_data_ann[, IMS_group])))
...
for (i in 1:N.sets) {
  ...
  if(Ethnicity_variable == "Assigned_Ethnicity_simplified"){
    TS.Surv[,"Group"] = factor(TS.Surv[,"Group"], levels = c("White", "Black", "Asian", "Unclear"))
  }
  ...
  # plots
  png(paste0("./Figures/Kaplan_meiers/C7_survival_by_IMS/", Ethnicity_variable,"_",IMS, "_", Outcome, "_Kaplan_Meijer_by_ethnicity_with_at_risk_table.png"),

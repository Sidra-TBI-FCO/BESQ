...
ICR_cluster = c("ICR High", "ICR Medium","ICR Low") # "All", "ICR High", "ICR Medium", "ICR Low"
...
for (i in 1:N.sets) {
  ...
  # plots
  png(paste0("./Figures/Kaplan_meiers/C29_survival_by_IMS/at_risk_v7_", Ethnicity_variable,"_", ICR_cluster, "_", IMS_group, "_", IMS, "_", Outcome, "_Kaplan_Meijer_by_ethnicity.png"),
      res=600, height=7,width=7,unit="in")                                                                                           # set filename
  ggkm(mfit,
       timeby=12,

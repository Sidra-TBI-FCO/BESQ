...
max_splits = read.csv(file = paste0("./Analysis/Hossam_prediction_model/cutoffs_JR/", tolower(Ethnicity) ,"s_cutoff.csv"), stringsAsFactors = FALSE)
...
dir.create("./Figures/Kaplan_meiers/C51_survival_by_pathway_category", showWarnings = FALSE)
...
for (i in 1:N.pathways){
  ...
  cutoff = max_splits$Cutoff[which(max_splits$Pathway == Pathway)]
  ...
  # plots
  png(paste0("./Figures/Kaplan_meiers/C51_survival_by_pathway_category/Sept_2019_", Ethnicity_variable,"_", Ethnicity, "_", Pathway,"_", classification, "_", Outcome, "_Kaplan_Meijer_by_cluster.png"),

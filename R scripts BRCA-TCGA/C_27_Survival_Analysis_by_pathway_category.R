...
load(paste0("./Analysis/C_26_Selected_pathway_classification/", IMS, "_", Pathway,"_", Ethnicity, "_", classification,"_classification.Rdata"))
...
dir.create("./Figures/Kaplan_meiers/C27_survival_by_pathway_category", showWarnings = FALSE)
...
Survival_data$cluster = df$Category[match(Survival_data$bcr_patient_barcode, substring(df$Sample, 1, 12))]
Survival_data = Survival_data[-which(is.na(Survival_data$cluster)),]
...
# plots
png(paste0("./Figures/Kaplan_meiers/C27_survival_by_pathway_category/July_2019_", Ethnicity_variable,"_", Ethnicity, "_", Pathway,"_", classification, "_", ICR_cluster, "_", IMS_group, "_", IMS, "_", Outcome, "_Kaplan_Meijer_by_cluster.png"),

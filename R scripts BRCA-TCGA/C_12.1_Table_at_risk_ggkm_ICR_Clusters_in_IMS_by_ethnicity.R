...
IMS_categories = c("All", names(table(Clinical_data_ann$IMS_Mathews)))
...
if(IMS == "All"){
}else{Survival_data_1 = Survival_data_1[which(Survival_data_1$IMS_Mathews == IMS),]}
...
for (i in 1:N.sets) {
  ...
  TS.EventFree = Survival_data[Survival_data[, Outcome] == "0", c(Outcome, paste0(Outcome, ".time"), "HML.ICR.Cluster")]
  ...
  TS.EventOccured = Survival_data[Survival_data[, Outcome] == "1", c(Outcome, paste0(Outcome, ".time"), "HML.ICR.Cluster")]
  ...
  # plots
  png(paste0("./Figures/Kaplan_meiers/C12_survival_ICR_by_Ethnicity/", Ethnicity, "_", IMS,"_", Outcome, "_",
             Combine_ICR_ML,
             "_Kaplan_Meijer_by_ICR_with_table_at_risk.png"),

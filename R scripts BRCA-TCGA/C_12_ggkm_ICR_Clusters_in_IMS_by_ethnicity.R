...
IMS_groups = c("All") # c("BasalMyo", "BasalHer2")
IMS = "All" # "BasalMyo_BasalHer2"
Combine_ICR_ML = "ICR_Medium_Low_combined" # "ICR_Medium_Low_combined" or ""
Benefit_cluster = "All" # "All" "beneficial" "non-beneficial"
...
if(IMS == "All"){
}else{Survival_data_1 = Survival_data_1[which(Survival_data_1$IMS_Mathews %in% IMS_groups),]}
...
for (i in 1:N.sets) {
  ...
  # plots
  png(paste0("./Figures/Kaplan_meiers/C12_survival_ICR_by_Ethnicity/20_Aug_19_Survival_and_diff_", Ethnicity, "_", IMS, "_", Outcome, "_",
